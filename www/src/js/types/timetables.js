...
export type ModuleLessonConfigWithLessons = { [LessonType]: ModifiableLesson[] };
...
export type TimetableDayFormat = { [DayText]: Array<ModifiableLesson> };

// TimetableDayArrangement is the arrangement of lessons on the timetable within a day.
export type TimetableDayArrangement = Array<Array<ModifiableLesson>>;
